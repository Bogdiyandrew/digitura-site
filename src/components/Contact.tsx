    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 w-full z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="flex flex-col gap-3 md:gap-4">
                <div className="relative group">
                  ...
                  <textarea
                    ...
                    placeholder="Scrie-ne câteva cuvinte despre proiectul tău..."
                    rows={4}
                    required
          ...
          <div
            id="direct-contact"
            className={`lg:col-span-2 flex flex-col gap-4 md:gap-8 transition-all duration-1000 ease-out delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            <h3 className="text-xl md:text-2xl font-bold text-white text-center lg:text-left mt-4 lg:mt-0">Contactează-ne direct</h3>
